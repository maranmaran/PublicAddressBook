...
[assembly: InternalsVisibleTo("Backend.LibraryTests")]
namespace Backend.Library.Logging
{
    internal class LoggingService : ILoggingService
    {
        ...
        internal void FileLog(LogLevel level, Exception exception, string message)
        {
            try
            {
        ...
        internal async Task DatabaseLog(LogLevel level, Exception exception, string message)
        {
            try
            {
                if (_logDb)
